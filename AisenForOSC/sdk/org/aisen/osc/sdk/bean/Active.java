...
import org.aisen.osc.sdk.support.utils.OSCUtils;
...
public class Active extends Entity {
	...
	public static Active parse(InputStream inputStream) throws TaskException {
		Active active = null;
        //获得XmlPullParser解析器
        XmlPullParser xmlParser = Xml.newPullParser();
        try {        	
            xmlParser.setInput(inputStream, OSCUtils.charset);
